...
/**
 * NVMe Command Accessor for Passthru 64byte NVMe command
 *
...
XNVME_STATIC_ASSERT(sizeof(struct xnvme_spec_cmd_passthru) == 64, "Incorrect size")
...
struct xnvme_spec_cmd {
	union {
		...
		struct xnvme_spec_cmd_passthru passthru;
